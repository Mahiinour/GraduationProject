...
class CelectronicsPage extends StatefulWidget{
  _CelectronicspageState createState() =>  _CelectronicspageState();
}

class  _CelectronicspageState  extends State<CelectronicsPage> {
  int currentIndex =0;
